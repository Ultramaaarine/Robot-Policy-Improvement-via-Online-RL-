...
class HybridPolicy(BasePolicy):
    def __init__(
        self,
        model: Lowdim_Unet, # encoder accept visual obs
        action_horizon: int,
    ...
    # -------------------------------------------------
     ...
     return n_cond, visual_cond, action_mask, stage
    ...
    w: Optional[torch.Tensor] = None
     ...
     n_cond, visual_obs, action_mask, stage = self._assemble_cond(
        cond_t=cond,
